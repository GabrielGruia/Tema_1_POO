...
1. Clasa "Individ", avand:
   ...
   * membrii privati:   		
    ...
    * metode private: 
            ...
            - inmulteste = adauga un fiu in stanga sau in dreapta individului daca pozitia este libera
                           (fiul are acelasi tip, varsta este 0, iar energia este de doua ori mai mare fata de cea a parintelui) 
